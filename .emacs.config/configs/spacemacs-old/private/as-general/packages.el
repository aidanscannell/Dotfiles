;;; packages.el --- as-general layer packages file for Spacemacs.
;;
;; Copyright (c) 2012-2018 Sylvain Benner & Contributors
;;
;; Author: Aidan Scannell <as12528@my.bristol.ac.uk>
...
;; added to `as-general-packages'. Then, for each package PACKAGE:
;;
;; - If PACKAGE is not referenced by any other Spacemacs layer, define a
;;   function `as-general/init-PACKAGE' to load and initialize the package.

;; - Otherwise, PACKAGE is already referenced by another Spacemacs layer, so
;;   define the functions `as-general/pre-init-PACKAGE' and/or
;;   `as-general/post-init-PACKAGE' to customize the package as it is loaded.

;;; Code:
(defconst as-general-packages '(
                                ;; helpful
                                ;; rainbow-mode
                                ;; helm-pages
                                ;; ;; evil-mc
...
(defun as-general/init-spacehammer ()
