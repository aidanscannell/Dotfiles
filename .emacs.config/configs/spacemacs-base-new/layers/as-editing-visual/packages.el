...
;; Removed highlight-indentation
;; Removed indent-guide
;; Added hook to highlight numbers in python
(setq as-editing-visual-packages
      '(
        ;; default
        ...
        highlight-numbers ;; makes numbers stand out a little bit
        highlight-parentheses ;; highlights the corresponding parentheses
        ;; indent-guide
        rainbow-delimiters ;; colours different delimeters according to depth
        volatile-highlights ;; show copied/deleted text - useful with undo-tree
        writeroom-mode ;; similar to olivetti mode
        ))

;; Initialization of packages

(defun as-editing-visual/init-writeroom-mode ()
...
(defun as-editing-visual/init-column-enforce-mode ()
...
(defun as-editing-visual/init-hide-comnt ()
  (use-package hide-comnt
    :commands hide/show-comments-toggle
    :init (spacemacs/set-leader-keys "ch" 'hide/show-comments-toggle)))

;; (defun as-editing-visual/init-highlight-indentation ()
...
(defun as-editing-visual/init-highlight-numbers ()
...
(defun as-editing-visual/init-highlight-parentheses ()
...
(defun as-editing-visual/init-hl-anything ()
...
;; (defun as-editing-visual/init-indent-guide ()
...
(defun as-editing-visual/init-rainbow-delimiters ()
...
(defun as-editing-visual/init-volatile-highlights ()
