...
(defconst media-packages
  '(
    ...
    (emms :location (recipe
                     ...
                     :files ("lisp/*.el"
                             ("~/.emacs.d/elpa/emms/" "Makefile")
                             ("~/.emacs.d/elpa/emms/" "src/*")
                             )
                     )
          )
    emms-state
  ...
  (use-package emms
    ...
    (progn
      ...
      (spacemacs/set-leader-keys
        ...
        "amer" 'emms-player-mpd-update-all-reset-cache
        )
    ...
    (progn
      ...
      (autoload 'emms-smart-browse "~/.emacs.d/elpa/emms/lisp/emms-browser.el" "Browse with EMMS" t)
