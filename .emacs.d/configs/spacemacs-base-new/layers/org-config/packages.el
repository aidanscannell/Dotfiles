...
;;                    ("\\subparagraph{%s}" . "\\subparagraph*{%s}")))
      ...
      (setq org-capture-templates
        `(
          ("l" "Linked Todo" entry (file+headline "~/Dropbox/org/1.todo.org" "Tasks")
          ...
          ("d" "Set Deadline" entry (file+headline "~/Dropbox/org/agenda/calendar.org" "Deadlines")
           "** %^{deadline name}\n %^g %? \n SCHEDULED: %t \n DEADLINE: %t")
          ...
          ("D" "Set PhD Deadline" entry (file+headline "~/Dropbox/org/agenda/uni.org" "Deadlines")
           "** %^{deadline name}\n %^g %? \n SCHEDULED: %t \n DEADLINE: %t")

          ("n" "Note" entry (file "~/Dropbox/org/notes.org"), "** %^{Note...}")

          ("r" "Research Ideas" entry (file+headline "~/Dropbox/org/notes.org" "Research Ideas")
           "* TODO %?\n%U")
          ...
          ("h" "Hugo post" entry (file+olp "all-posts.org" "Blog Ideas") (function org-hugo-new-subtree-post-capture-template))
